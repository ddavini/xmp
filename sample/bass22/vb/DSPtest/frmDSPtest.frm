...
Private Sub cmdOpen_Click()
    ...
    chan = BASS_StreamCreateFile(BASSFALSE, cmd.FileName, 0, 0, BASS_SAMPLE_LOOP Or floatable)
    If (chan = 0) Then chan = BASS_MusicLoad(BASSFALSE, cmd.FileName, 0, 0, BASS_MUSIC_LOOP Or BASS_MUSIC_RAMPS Or floatable, 0)
