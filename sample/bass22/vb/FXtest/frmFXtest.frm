...
'///////////////////////////////////////////////////////////////////////////////
' frmFXtest.frm - Copyright (c) 2001-2005 (: JOBnik! :) [Arthur Aminov, ISRAEL]
'                                                       [http://www.jobnik.org]
'                                                       [  jobnik@jobnik.org  ]
'
...
#If 1 Then 'with FX flag
    ...
    chan = BASS_StreamCreateFile(BASSFALSE, CMD.FileName, 0, 0, BASS_SAMPLE_LOOP Or BASS_SAMPLE_FX)
    If (chan = 0) Then chan = BASS_MusicLoad(BASSFALSE, CMD.FileName, 0, 0, BASS_MUSIC_LOOP Or BASS_MUSIC_RAMP Or BASS_SAMPLE_FX, 0)
...
#End If
    ...
    fx(0) = BASS_ChannelSetFX(chan, BASS_FX_PARAMEQ, 0) 'bass
    fx(1) = BASS_ChannelSetFX(chan, BASS_FX_PARAMEQ, 0) 'mid
    fx(2) = BASS_ChannelSetFX(chan, BASS_FX_PARAMEQ, 0) 'treble
    fx(3) = BASS_ChannelSetFX(chan, BASS_FX_REVERB, 1)  'reverb
