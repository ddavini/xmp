...
;                       modified for BASS 1.6 (added qinvoke macro)
...
;     ~~~~~~~~~
      ...
      ; ----------------------------------------
      ; qinvoke - macro for functions with QWORD
      ; ----------------------------------------
...
WndProc proc hWin   :DWORD,
    ...
    ;======== toolbar commands ========
        ...
        .elseif wParam == 52
            invoke BASS_MusicGetOrderPosition, ModHandle
            .if eax != -1
                mov ebx, eax
                .while 1
                    dec ebx
                    and ebx, 0000000011111111b
                    qinvoke BASS_ChannelSetPosition, ModHandle, MAKEMUSICPOS(bx,0)
                .break .if eax
                .endw
            .endif
        ...
        .elseif wParam == 54
            .if SurroundOn == FALSE
                invoke BASS_ChannelSetFlags, ModHandle, BASS_SAMPLE_LOOP or \
                       BASS_MUSIC_POSRESET or BASS_MUSIC_RAMPS or BASS_MUSIC_SURROUND
                mov SurroundOn, TRUE
            .else
                 invoke BASS_ChannelSetFlags, ModHandle, BASS_SAMPLE_LOOP or \
                        BASS_MUSIC_POSRESET or BASS_MUSIC_RAMPS
    ...
    ;======== menu commands ========
        ...
        .if wParam == 1001
            ...
            .endif
            invoke BASS_MusicLoad, 0, ADDR szFileName, 0, 0, eax, 0    ; load musicfile
            test eax,eax
            jz error
        
            mov [ModHandle], eax                                    ; save handle for future use
            invoke BASS_MusicGetName, ModHandle
            mov [ModName], eax
