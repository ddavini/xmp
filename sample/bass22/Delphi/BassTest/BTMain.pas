...
begin
	...
	// Ensure BASS 2.2 was loaded
	if BASS_GetVersion() <> DWORD(MAKELONG(2,2)) then begin
		Error('BASS version 2.2 was not loaded!');
		Halt;
	end;
...
begin
  ...
  begin
    ...
    BASS_ChannelSetAttributes(ch, -1, 50, Random(200) - 100);
		if not BASS_ChannelPlay(sams[i], False) then
